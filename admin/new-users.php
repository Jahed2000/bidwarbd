...
?>
    ...
    <div class="main-bar">
        <h3>
            <i class="fa fa-user"></i>&nbsp; New Users
        </h3>
    </div>
                    ...
                    <form action="deleteSelected.php" method="post">
                        ...
                        <div class="col-md-12" style="margin-top:50px;margin-bottom: 50px;">
                            ...
                            <table id="example" class="table table-striped table-bordered dt-responsive nowrap"
                                ...
                                <?php
                                $serialNumber = 1;
                                foreach ($getAllNewUsers as $user) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <p data-placement="top" data-toggle="tooltip" title="Approve">
                                                <a class="btn btn-success btn-xs" data-title="Approve"
                                                        data-toggle="modal"
                                                        data-target="#approve<?php echo $user->id ?>"><span
                                            ...
                                            <p data-placement="top" data-toggle="tooltip" title="Ban">
                                                <a class="btn btn-warning btn-xs" data-title="Ban"
                                                        data-toggle="modal"
                                                        data-target="#ban<?php echo $user->id ?>"><span
                                            ...
                                            <p data-placement="top" data-toggle="tooltip" title="Delete">
                                                <a class="btn btn-danger btn-xs" data-title="Delete"
                                                        data-toggle="modal"
                                                        data-target="#delete<?php echo $user->id ?>"><span
                                    ...
                                    <!-- approve modal -->
                                    <div class="modal fade" id="approve<?php echo $user->id ?>" tabindex="-1"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer ">
                                                    <a href="approveAUser.php?id=<?php echo $user->id ?>">
                                    ...
                                    <!-- ban modal -->
                                    <div class="modal fade" id="ban<?php echo $user->id ?>" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer ">
                                                    <a href="ban.php?id=<?php echo $user->id ?>">
                                                        <button type="button" class="btn btn-success"><span
                                                                class="glyphicon glyphicon-ok-sign"></span> Yes
                                                        </button>
                                                    </a>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="alert alert-danger"><span
                                                            class="glyphicon glyphicon-trash"></span> Are
                                                        you sure you want to delete this User?
                                                    </div>
                                                </div>
                                                <div class="modal-footer ">
                                                    <a href="deleteAUser.php?id=<?php echo $user->id ?>">
                                                        <button type="button" class="btn btn-success"><span
                                                                class="glyphicon glyphicon-ok-sign"></span> Yes
                                                        </button>
                                                    </a>
