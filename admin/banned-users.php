                    ...
                    <form action="deleteSelected.php" method="post">
                        ...
                        <div class="col-md-12" style="margin-top:50px;margin-bottom: 50px;">
                            <table id="example" class="table table-striped table-bordered dt-responsive nowrap"
                                ...
                                <thead>
                                <tr>
                                    <th><input hidden type="text" name="banned_user" value="1"></th>
                                ...
                                foreach ($getAllBannedUsers as $user) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <p data-placement="top" data-toggle="tooltip" title="Unban">
                                                <a class="btn btn-primary btn-xs" data-title="Unban"
                                                        data-toggle="modal"
                                                        data-target="#unban<?php echo $user->id ?>"><span
                                    ...
                                    <!-- approve modal -->
                                    <div class="modal fade" id="unban<?php echo $user->id ?>" tabindex="-1"
                                         role="dialog"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <h4 class="modal-title custom_align" id="Heading">Unban this
                                                        user</h4>
                                                </div>
                                                ...
                                                <div class="modal-footer ">
                                                    <a href="unbanAUser.php?id=<?php echo $user->id ?>&banned_user=1">
                                    ...
                                    <div class="modal fade" id="delete<?php echo $user->id ?>" tabindex="-1"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer ">
                                                    <a href="deleteAUser.php?id=<?php echo $user->id ?>&banned_user=1">
                                                        <button type="button" class="btn btn-success"><span
                                                                class="glyphicon glyphicon-ok-sign"></span> Yes
                                                        </button>
                                                    </a>
