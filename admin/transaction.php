...
?>
    ...
    <div class="main-bar">
        <h3>
            <i class="fa fa-user"></i>&nbsp; Transaction Approval
        </h3>
    </div>
                            ...
                            <table id="example" class="table table-striped table-bordered dt-responsive nowrap"
                                ...
                                foreach ($transactionData as $trans) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $trans->user_cash ?></td>
                                       
                                        <td>
                                            <p data-placement="top" data-toggle="tooltip" title="done">
                                                <a class="btn btn-success btn-xs" data-title="done"
                                                        data-toggle="modal"
                                                        data-target="#approve<?php echo $trans->id ?>"><span
